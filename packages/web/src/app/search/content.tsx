    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSearch} className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
        <div className="flex gap-4">
          ...
          <button
            type="submit"
            className="bg-ueno-blue text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-600 transition-colors"
          >
            Buscar
          </button>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12 text-gray-400">
          ...
          <p className="text-sm mt-2">
            Ej: &quot;cafeterías populares en Asunción con buena presencia en Instagram&quot;
          </p>
        </div>
      )}
    </div>
